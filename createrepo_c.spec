...
Version  : 0.20.1
Release  : 81
URL      : https://github.com/rpm-software-management/createrepo_c/archive/0.20.1/createrepo_c-0.20.1.tar.gz
Source0  : https://github.com/rpm-software-management/createrepo_c/archive/0.20.1/createrepo_c-0.20.1.tar.gz
...
%prep
%setup -q -n createrepo_c-0.20.1
cd %{_builddir}/createrepo_c-0.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687204485
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcreaterepo_c.so.0.20.1
/usr/lib64/libcreaterepo_c.so.0
/usr/lib64/libcreaterepo_c.so.0.20.1
