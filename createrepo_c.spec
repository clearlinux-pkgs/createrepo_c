...
Version  : 0.17.5
Release  : 66
URL      : https://github.com/rpm-software-management/createrepo_c/archive/0.17.5/createrepo_c-0.17.5.tar.gz
Source0  : https://github.com/rpm-software-management/createrepo_c/archive/0.17.5/createrepo_c-0.17.5.tar.gz
...
%prep
%setup -q -n createrepo_c-0.17.5
cd %{_builddir}/createrepo_c-0.17.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631764999
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/createrepo_c-0.17.5/COPYING %{buildroot}/usr/share/package-licenses/createrepo_c/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libcreaterepo_c.so.0.17.5
