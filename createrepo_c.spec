...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656437158
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/createrepo_c-0.20.1/COPYING %{buildroot}/usr/share/package-licenses/createrepo_c/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
